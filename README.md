...
1. Enter [http://localhost:8080](http://localhost:8080) on your preferred browser. The login page appears, enter the username and password as configured in the `.env` file. The default is admin/admin. Refer to the image below:<br/> ![alt_text](assets/image2.png "image_tooltip")
