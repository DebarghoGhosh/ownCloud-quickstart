...
3. Skip the message for installing desktop and mobile clients. The files page is displayed as shown below:<br/><br/> ![alt_text](assets/image4.png "image_tooltip")
